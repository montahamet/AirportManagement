...
namespace AM.ApplicationCore.Domain
{
    public static class TestData
    {
        ...
        public static Staff hostess1 = new Staff { FullName = new FullName { FirstName = "hostess1", LastName = "hostess1" }, EmailAddress = "hostess1.hostess1@gmail.com", Birthdate = new DateTime(1995, 01, 01), EmploymentDate = new DateTime(2020, 01, 01), Salary = 999 };
        public static Staff hostess2 = new Staff { FullName = new FullName { FirstName = "hostess2", LastName = "hostess2" }, EmailAddress = "hostess2.hostess2@gmail.com", Birthdate = new DateTime(1996, 01, 01), EmploymentDate = new DateTime(2020, 01, 01), Salary = 999 };
        // Travellers
        ...
        public static Flight flight1 = new Flight
        {
            ...
            //Passangers = new List<Passenger> { captain, hostess1, hostess2, traveller1, traveller2, traveller3, traveller4, traveller5 }
       ,
            MyPlane = Airbusplane
        };
        public static Flight flight2 = new Flight { FlightDate = new DateTime(2022, 02, 01, 21, 10, 10), Destination = "Paris", EffectiveArrival = new DateTime(2022, 02, 01, 23, 10, 10), EstimatedDuration = 105, MyPlane = BoingPlane,Departure="Tunis", AirlineLogo = "" };
